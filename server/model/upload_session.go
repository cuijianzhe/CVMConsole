...
type UploadSession struct {
	...
	FileHash      string    `gorm:"size:64;not null;default:''" json:"file_hash"`     // 整文件 MD5（秒传 + 最终校验）
	...
	Status        string    `gorm:"size:16;not null;default:'uploading'" json:"status"` // uploading | completed | canceled
