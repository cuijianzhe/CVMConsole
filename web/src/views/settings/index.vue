...
const form = reactive({
  ...
  rescue_iso: '',
  public_base_url: '',
  site_title: 'CVMConsole',
  system_home_icon: '',
  home_title: 'CVMConsole',
  login_page_icon: '',
  product_name: '',
  browser_favicon: '',
  browser_title: 'CVMConsole',
...
const fetchData = async () => {
  loading.value = true
  try {
    const [settingsResult, isoResult, kvmResult, ksmResult, zramResult, igpuResult] = await Promise.allSettled([
      getSettings(),
      getAllISOs(),
